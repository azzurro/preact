...
(n.Component.prototype.forceUpdate = function(n) {
	...
	(function() {
					...
					(o = n.type.propTypes),
						...
						Object.keys(o).forEach(function(n) {
							...
							!t ||
								t.message in e ||
								((e[t.message] = !0),
								console.error('Failed ' + i + ' type: ' + t.message));
						});
				}
				a && a(n);
			}),
		...
		var v = function(n, e) {
			...
			m = {
				nodeName: v('nodeName', 'use vnode.type'),
				attributes: v('attributes', 'use vnode.props'),
				children: v('children', 'use vnode.props.children')
			},
			b = Object.create({}, m);
		(n.options.vnode = function(n) {
			var e = n.props;
